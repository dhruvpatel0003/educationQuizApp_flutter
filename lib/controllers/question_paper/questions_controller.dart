...
import 'package:education_app/controllers/question_paper/question_controller_extension.dart';
...
class QuestionsController extends GetxController {
  ...
  void onReady() {
    ...
    print("Inside the questionsController, title : ${_questionPaper.title}");
  ...
  Future<void> loadData(QuestionPaperModel questionPaper) async {
    ...
    if (questionPaper.questions != null &&
      ...
      print("The actual question is : ${questionPaper.questions![0].question}");
  ...
  _startTimer(int seconds) {
    ...
    _timer = Timer.periodic(duration, (Timer timer) {
      if (remainSeconds == 0) {
        ...
        int minutes = remainSeconds ~/ 60; //170/60=2.833, then minutes = 2
